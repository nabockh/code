function drawQuartileChart(chartData, divId) {
    ...
    var quartileOptions = {
        ...
        bar: {groupWidth: 6},
        tooltip: { isHtml : true },
        hAxis: { baselineColor: '#fff', gridlines: {color: '#fff'}, title : '', titleTextStyle: {color: '#33626e'}, viewWindow: { min: 0, max: 5}, ticks: [{v:0, f: '0'}, {v:1, f: '1st Quartile'}, {v:2, f: '2nd Quartile'}, {v:3, f: '3rd Quartile'}, {v:4, f: '4th Quartile'}]},
    };
