...
from metrics.models import EventType, TYPE_HTTP_REQUEST
...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        base_type = EventType.get(TYPE_HTTP_REQUEST)
        EventType.register(metric_events.BM_CREATE_OPEN, base_type)
        EventType.register(metric_events.BM_CREATE_DONE, base_type)
        EventType.register(metric_events.BM_ANSWER_OPEN, base_type)
        EventType.register(metric_events.BM_ANSWER_SAVE, base_type)
        EventType.register(metric_events.BM_DETAIL_OPEN, base_type)
        EventType.register(metric_events.BM_RATE_SAVE, base_type)
        EventType.register(metric_events.BM_EXCEL_EXPORT, base_type)
        EventType.register(metric_events.BM_HISTORY_OPEN, base_type)
        EventType.register(metric_events.BM_ADD_PARTICIPANTS, base_type)
        EventType.register(metric_events.DASHBOARD_OPEN, base_type)
        EventType.register(metric_events.HOME_OPEN, base_type)
        EventType.register(metric_events.LOGIN, base_type)
        EventType.register(metric_events.LOGOUT, base_type)

    def backwards(self, orm):
        base_type = EventType.get(TYPE_HTTP_REQUEST)
        if base_type:
            EventType.register(metric_events.BM_CREATE_OPEN, base_type).delete()
            EventType.register(metric_events.BM_CREATE_DONE, base_type).delete()
            EventType.register(metric_events.BM_ANSWER_OPEN, base_type).delete()
            EventType.register(metric_events.BM_ANSWER_SAVE, base_type).delete()
            EventType.register(metric_events.BM_DETAIL_OPEN, base_type).delete()
            EventType.register(metric_events.BM_RATE_SAVE, base_type).delete()
            EventType.register(metric_events.BM_EXCEL_EXPORT, base_type).delete()
            EventType.register(metric_events.BM_HISTORY_OPEN, base_type).delete()
            EventType.register(metric_events.BM_ADD_PARTICIPANTS, base_type).delete()
            EventType.register(metric_events.DASHBOARD_OPEN, base_type).delete()
            EventType.register(metric_events.HOME_OPEN, base_type).delete()
            EventType.register(metric_events.LOGIN, base_type).delete()
            EventType.register(metric_events.LOGOUT, base_type).delete()
    ...
    models = {
        ...
        u'bm.bminviteemail': {
            'Meta': {'object_name': 'BmInviteEmail'},
            'benchmark': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'invitation_email'", 'to': u"orm['bm.Benchmark']"}),
        ...
        u'bm.responseyesno': {
            'Meta': {'object_name': 'ResponseYesNo'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'response': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'data_boolean'", 'to': u"orm['bm.QuestionResponse']"}),
