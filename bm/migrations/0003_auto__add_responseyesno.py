...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ResponseYesNo'
        db.create_table(u'bm_responseyesno', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('response', self.gf('django.db.models.fields.related.ForeignKey')(related_name='data_boolean', to=orm['bm.QuestionResponse'])),
            ('value', self.gf('django.db.models.fields.BooleanField')()),
        ))
        db.send_create_signal(u'bm', ['ResponseYesNo'])


    def backwards(self, orm):
        # Deleting model 'ResponseYesNo'
        db.delete_table(u'bm_responseyesno')
