...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BmInviteEmail'
        db.create_table(u'bm_bminviteemail', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('benchmark', self.gf('django.db.models.fields.related.ForeignKey')(related_name='invitation_email', to=orm['bm.Benchmark'])),
            ('body', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'bm', ['BmInviteEmail'])


    def backwards(self, orm):
        # Deleting model 'BmInviteEmail'
        db.delete_table(u'bm_bminviteemail')
